...
This naming concept is used in projects for Toyota, ProSiebenSat.1, MyVideo and Maxdome.


Class Names
-----------

There are thre basic rules to keeping it simple:

* Lower case letters
* Dash case
* **Meanngful, natural names**
...
CSS is much more maintainable if you avoid cascading altogether and just use class names.
...
Modifiers should be applied to the module class only and named in a way to identify it as a modifier (mostly `is-...`):
