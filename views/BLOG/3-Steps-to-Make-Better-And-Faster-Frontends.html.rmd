...
3 Steps to Make<br>Better & Faster<br>Frontends<br><small>With Sass/SCSS, Compass and Lemonade’s CSS Sprites</small>
====================================================================================================================

<%= slideshare 'sass-scss-compass-lemonade-100703091111-phpapp02' %>

I gave this talk at the awesame [Railscamp 4](http://www.railscamp.de).
In my blog post [Generate CSS Sprites on the Fly with Lemonade](Lemonade-CSS-Sprites-for-Sass-Compass.html) I gave more details about how to use [lemonade for CSS sprites](http://github.com/hagenburger/lemonade).
